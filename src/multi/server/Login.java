...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setFont(new java.awt.Font("Adobe Caslon Pro", 0, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Datang !!!");

        jPanel3.setBackground(new java.awt.Color(51, 51, 51));

        jLabel1.setFont(new java.awt.Font("Adobe Caslon Pro", 0, 11)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("USER");

        jLabel2.setFont(new java.awt.Font("Adobe Caslon Pro", 0, 11)); // NOI18N
    ...
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        ...
        String User = (String)user.getText();
        String Pass = (String)pass.getText();
        
        akses masuk = new akses () ;
        masuk.check(User, Pass);    
